...
*   **Claim Liberty Section:** Interactive section explaining the 4-step token claiming process with a call-to-action button linking to `/ownership`. Features step-by-step breakdown: (1) Connect Bitcoin wallet, (2) Verify ownership via signature, (3) Link Liberty wallet address, (4) Claim LBTY tokens at 1:10 ratio. Positioned after Treasury section to guide users through the claiming journey.
