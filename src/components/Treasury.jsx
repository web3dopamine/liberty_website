            ...
            <div className="flex flex-col md:flex-row mt-12 md:mt-8 gap-6 md:gap-18 lg:gap-30 ml-0 md:ml-3 items-start">
              <div className="flex flex-col gap-4">
                <div className="flex flex-col">
                  ...
                  <div className="text-[#000000] text-[16px] font-medium">73.7</div>
                </div>
                <div className="flex flex-col">
                  <div className="flex flex-row items-center gap-3 mb-1">
                  ...
                  <div className="text-[#000000] text-[16px] font-medium">8.6</div>
                </div>
              </div>
              <div className="flex flex-col gap-4">
                <div className="flex flex-col">
                  ...
                  <div className="text-[#000000] text-[16px] font-medium">12.5</div>
                </div>
                <div className="flex flex-col">
                  <div className="flex flex-row items-center gap-3 mb-1">
                    <div className="w-[16px] h-[16px] shadow-sm bg-[#6EB5B1] rounded-3xl" />
                  ...
                  <div className="text-[#000000] text-[16px] font-medium">5.2</div>
                </div>
              </div>
            </div>
          </div>
